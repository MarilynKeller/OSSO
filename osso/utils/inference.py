...
def infer_skeleton(skin_pkl_path, skel_mesh_path, skel_pkl_path, skin_mesh_lying_path, gender, display=False, verbose=False, per_parts=False):
    ...
    if per_parts:  
        per_parts_folder = skin_mesh_lying_path.replace('.ply', '_per_parts')
        os.makedirs(per_parts_folder, exist_ok=True)
        export_per_part(sp, per_parts_folder)